...
class TrudVsem(VacancyApi):
    """
    Класс TrudVsem наследующий от абстрактного класса VacancyApi. Он содержит переменную _api_link,
    ...
    def get_keywords_vacancies(self, keywords, n=30):
        ...
        """
        return self.get_vacancies_api(text=keywords, limit=n)
