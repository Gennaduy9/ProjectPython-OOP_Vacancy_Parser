...
def get_prettytable():
    """
    Создает объект класса PrettyTable и задает названия столбцов таблицы.
    """
    table = PrettyTable()
...
def print_prettytable_hhru(json_data, sorty: str):
    """
    Формирует таблицу для данных о вакансиях с сайта hh.ru.
    Принимает на вход словарь json_data с данными о вакансиях и строку sorty с названием столбца,
    по которому нужно отсортировать таблицу. Возвращает строку с отформатированной таблицей.
    """
...
def print_prettytable_sj(json_data, sorty):
    """
    Формирует таблицу для данных о вакансиях с сайта superjob.ru.
    Принимает на вход словарь json_data с данными о вакансиях и строку sorty с названием столбца,
    по которому нужно отсортировать таблицу. Возвращает строку с отформатированной таблицей.
    """
...
def print_prettytable_zp(json_data, sorty: str):
    """
    Формирует таблицу для данных о вакансиях с сайта zarplata.ru.
    Принимает на вход словарь json_data с данными о вакансиях и строку sorty с названием столбца,
    по которому нужно отсортировать таблицу. Возвращает строку с отформатированной таблицей.
    """
...
def print_prettytable_tv(json_data, sorty):
    """
    Формирует таблицу для данных о вакансиях с сайта trudvsem.ru.
    Принимает на вход словарь json_data с данными о вакансиях и строку sorty с названием столбца,
    по которому нужно отсортировать таблицу. Возвращает строку с отформатированной таблицей.
    """
