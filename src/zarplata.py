...
class ZarpLATA(VacancyApi):
    """
    Класс ZarpLATA наследующий от абстрактного класса VacancyApi. Он содержит переменную _api_link,
    которая хранит ссылку на API, и методы init() и str(), которые инициализируют переменную
    filename и возвращают строку "crewing.ru" соответственно.
    """
    _api_link = "https://api.zarplata.ru/vacancies"

    def __init__(self):
        filename = "zarplata.json"
